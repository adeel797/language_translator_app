...
@GenerateMocks(
  ...
  customMocks: [
    ...
    MockSpec<TranslatorService>(onMissingStub: OnMissingStub.returnDefault),
...
void registerServices() {
  ...
  getAndRegisterTranslatorService();
...
MockTranslatorService getAndRegisterTranslatorService() {
  _removeRegistrationIfExists<TranslatorService>();
  final service = MockTranslatorService();
  locator.registerSingleton<TranslatorService>(service);
  return service;
}
